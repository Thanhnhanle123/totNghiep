...
@section('Content')
    <div class="wrapper">
        <div class="content-wrapper">
            @include('partials.content_header',['name'=>'Đảng Viên đã xóa','title'=>'Danh sách','route' => 'dangviendaxoa.danhsach'])
            <!-- Main content -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a class="btn  btn-primary float-right m-2 c " href="{{ route('dangvien.danhsach') }}"> Đảng viên </a>
                            </div>
